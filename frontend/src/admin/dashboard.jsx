        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <Drawer
                ...
                sx={{
                    width: 240,
                    flexShrink: 0,
                    [`& .MuiDrawer-paper`]: { width: 240, boxSizing: 'border-box', backgroundColor: '#000' }, // Drawer background set to black
                }}
            >
                {/* Sidebar content */}
                ...
                <List>
                    ...
                    <Collapse in={openSections.tktBooking} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItem button sx={{ pl: 4 }}>
                                ...
                                <ListItemText primary="Book Ticket" sx={{ color: '#fff' }} />
                            </ListItem>
                            <ListItem button sx={{ pl: 4 }}>
                                <ListItemIcon sx={{ color: '#fff' }}>
                                    <Cancel />
                                </ListItemIcon>
                                <ListItemText primary="Cancel Ticket" sx={{ color: '#fff' }} />
                            </ListItem>
                        </List>
                    </Collapse>
                    ...
                    <Collapse in={openSections.status} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            ...
                            <ListItem button sx={{ pl: 4 }}>
                                <ListItemText primary="Service 1" sx={{ color: '#fff' }} />
                            </ListItem>
                            <ListItem button sx={{ pl: 4 }}>
                                <ListItemText primary="Service 2" sx={{ color: '#fff' }} />
                            </ListItem>
                            <ListItem button sx={{ pl: 4 }}>
                                <ListItemText primary="Service 3" sx={{ color: '#fff' }} />
                            </ListItem>
                        </List>
                    </Collapse>
