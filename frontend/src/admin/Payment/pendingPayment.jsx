        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
                ...
                <Container>
                    ...
                    <div style={{ display: 'flex', gap: '2rem', marginBottom: '2rem', alignItems: 'center', justifyContent: 'space-evenly' }}>
                        <Select
                            defaultValue="Only Pending"
                            variant="outlined"
                            sx={{ minWidth: 200 }}
                        >
                            <MenuItem value="Only Pending">Only Pending</MenuItem>
                        ...
                        <Table>
                            <TableHead>
                                <TableRow style={{ backgroundColor: '#000080' }}>
                                    {['Booking ID', 'Mobile No.', 'Ticket Amt', 'Advance', 'Adv Date', '2nd Amt', '2nd Date', '3rd Amt', '3rd Date', 'Total Paid', 'Pending'].map((header) => (
                    ...
                    {/* Summary row */}
                    <div style={{ backgroundColor: '#000080', color: '#FFFFFF', textAlign: 'right', padding: '8px', marginTop: '1rem' }}>
                        <Typography variant="body1">Total Ticket Amt: 11,643,481.0 | Total Advance: 4,545,075.0 | Total Paid: 3,181,678.0 | Pending: 7,726,753.0</Typography>
                    </div>
                </Container>
            </Box>
        </Box>
